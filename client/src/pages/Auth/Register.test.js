...
describe("Register Component", () => {
  ...
  it("should display response error message if response is 200 but success is false", async () => {
    axios.post.mockResolvedValueOnce({
      data: { success: false, message: "Custom test message" },
    });
    ...
    await waitFor(() => expect(axios.post).toHaveBeenCalled());
    expect(toast.error).toHaveBeenCalledWith("Custom test message");
    expect(navigate).not.toHaveBeenCalled();
  });
});
